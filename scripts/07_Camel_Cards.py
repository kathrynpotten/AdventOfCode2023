...
class Hand:
    ...
    def hand_type(self):
        ...
        elif card_count.most_common()[0][1] == 4:
...
test_cards = [Card("3"), Card("2"), Card("T"), Card("3"), Card("K")]
test_hand = Hand(test_cards, 765)

assert str(test_hand) == "One Pair: 32T3K"

test_cards_2 = [Card("4"), Card("4"), Card("K"), Card("Q"), Card("5")]
test_hand_2 = Hand(test_cards_2, 100)


assert test_hand_2 == test_hand
...
answer_1 = play_round(input_data)
print(answer_1)
